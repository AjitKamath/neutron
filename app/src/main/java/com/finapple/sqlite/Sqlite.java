...
public class Sqlite extends SQLiteOpenHelper{
	...
	public void createTransactionTable(SQLiteDatabase db){
		...
		sqlQuerySB.append(" SCH_TRAN_ID TEXT NOT NULL, ");	//fk5
	...
	public void onUpgrade(SQLiteDatabase db, int oldVersion, int newVersion) {
		...
		db.execSQL("DROP TABLE IF EXISTS " + SPENT_ON_TABLE);
		db.execSQL("DROP TABLE IF EXISTS " + TRANSACTION_TABLE);
		db.execSQL("DROP TABLE IF EXISTS " + SCHEDULED_TRANSACTION_TABLE);
