...
public class AddUpdateBudgetSpinnerAdapter extends ArrayAdapter<SpinnerModel>{

    private Activity context;
    private List<SpinnerModel> dataList;
    private List<Integer> colorList;
    private int resourceId;
    private String spinnerTypeStr;

    LayoutInflater inflater;

    public AddUpdateBudgetSpinnerAdapter(Activity context, int resourceId, List<SpinnerModel> dataList){
        super(context, resourceId, dataList);
        this.context = context;
        this.dataList = dataList;
        this.resourceId = resourceId;
        this.spinnerTypeStr = spinnerTypeStr;
