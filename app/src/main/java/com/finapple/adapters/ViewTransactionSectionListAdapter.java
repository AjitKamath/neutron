...
public class ViewTransactionSectionListAdapter extends BaseAdapter {
    ...
    private void makeListItem(int position, View convertView) {
        ...
        //ImageView viewTransactTileSchTransactIV = (ImageView) convertView.findViewById(R.id.viewTransactTileSchTransactIVId);
        ImageView viewTransactTileCurIV = (ImageView) convertView.findViewById(R.id.viewTransactTileCurIVId);
        TextView viewTransactTileAmtTV = (TextView) convertView.findViewById(R.id.viewTransactTileAmtTVId);
        TextView viewTransactTileAmtApproxTV = (TextView) convertView.findViewById(R.id.viewTransactTileAmtApproxTVId);
        TextView viewTransactTileTypTV = (TextView) convertView.findViewById(R.id.viewTransactTileTypTVId);
        ...
        //show sch_tran icon only if its a scheduled transaction
        /*if(transactionObj.getSCH_TRAN_ID() == null){
            viewTransactTileSchTransactIV.setVisibility(View.GONE);
        }*/

        //TODO: APPROXIMATIZATION IS REQUIRED

        if("EXPENSE".equalsIgnoreCase(transactionObj.getTRAN_TYPE())){
            viewTransactTileTypTV.setBackgroundResource(R.drawable.circle_expense_text_view);
            viewTransactTileTypTV.setText("E");
            ...
            viewTransactTileTypTV.setBackgroundResource(R.drawable.circle_income_text_view);
            viewTransactTileTypTV.setText("E");
