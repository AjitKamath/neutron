 ...
 */
public class CountriesFragmentListViewAdapter extends BaseAdapter {
    ...
    public CountriesFragmentListViewAdapter(Context mContext, List<CountryMO> countriesList, String selectedCountryIdStr) {
        super();
