 ...
 */
public class SelectRepeatFragmentListViewAdapter extends BaseAdapter {
    ...
    public SelectRepeatFragmentListViewAdapter(Context mContext, List<RepeatMO> repeatsList, String selectedRepaetIdStr) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder mHolder;
        int layout = R.layout.select_repeat_repeat;
