 ...
 */
public class SelectSpentonFragmentListViewAdapter extends BaseAdapter {
    ...
    public SelectSpentonFragmentListViewAdapter(Context mContext, List<SpentOnMO> spentonsList, String selectedSpentonIdStr) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder mHolder;
        int layout = R.layout.select_spenton_spenton;
        ...
        if(convertView == null) {
            ...
            mHolder.spentonSelectedV = convertView.findViewById(R.id.spentonSelectedVId);
