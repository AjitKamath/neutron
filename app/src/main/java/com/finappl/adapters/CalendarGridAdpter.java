...
public class CalendarGridAdpter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        if(monthLegendDataMap != null && monthLegendDataMap.containsKey(dateToCheckStr)) {
            ...
            if(monthLegendDataMap.get(dateToCheckStr).getSummaryModel() != null
                        && !monthLegendDataMap.get(dateToCheckStr).getSummaryModel().getConsolidatedTransactionModelMap().isEmpty()){
            ...
            if(monthLegendDataMap.get(dateToCheckStr).getSummaryModel() != null
                    && !monthLegendDataMap.get(dateToCheckStr).getSummaryModel().getConsolidatedTransferModelMap().isEmpty()){
