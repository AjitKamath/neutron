 ...
 */
public class SelectAccountFragmentListViewAdapter extends BaseAdapter {
    ...
    public SelectAccountFragmentListViewAdapter(Context mContext, List<AccountMO> accountsList, String selectedAccountIdStr, UserMO loggedInUserMO) {
        super();
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ViewHolder mHolder;
        int layout = R.layout.select_account_account;
